...
if [ "$mode" == "CO2" ]; then
    ...
    nexus -n $N_EVENTS ${INIT}
    python3 ${SCRIPT} ${JOBNAME}_5bar 0 5 10 5.0 ${JOBID} # Just smearing [bin was 3]
    ...
    nexus -n $N_EVENTS ${INIT}
    python3 ${SCRIPT} ${JOBNAME}_10bar 0 5 10 10.0 ${JOBID} # Just smearing [bin was 2]
    ...
    nexus -n $N_EVENTS ${INIT}
    python3 ${SCRIPT} ${JOBNAME}_15bar 0 5 10 15.0 ${JOBID} # Just smearing [bin was 1]
