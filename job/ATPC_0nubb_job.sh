...
if [ "$MODE" == "1bar" ]; then
    ...
    python3 GetTrueInfo.py 1 0nubb ${JOBNAME}_1bar_Efilt.h5
    ...
    # Get true info about the blobs etc
    python3 GetTrueInfo.py 5 0nubb ${JOBNAME}_5bar_Efilt.h5
    ...
    # Get true info about the blobs etc
    python3 GetTrueInfo.py 10 0nubb ${JOBNAME}_10bar_Efilt.h5
    ...
    # Get true info about the blobs etc
    python3 GetTrueInfo.py 15 0nubb ${JOBNAME}_15bar_Efilt.h5
    ...
    # Get true info about the blobs etc
    python3 GetTrueInfo.py 25 0nubb ${JOBNAME}_25bar_Efilt.h5
