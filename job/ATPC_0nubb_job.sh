...
if [ "$MODE" == "1bar" ]; then
    ...
    python3 GetTrueInfo.py ${JOBNAME}_1bar_Efilt 1 0nubb
    ...
    # Get true info about the blobs etc
    python3 GetTrueInfo.py ${JOBNAME}_5bar_Efilt 1 0nubb
    ...
    # Get true info about the blobs etc
    python3 GetTrueInfo.py ${JOBNAME}_10bar_Efilt 1 0nubb
    ...
    # Get true info about the blobs etc
    python3 GetTrueInfo.py ${JOBNAME}_15bar_Efilt 1 0nubb
    ...
    # Get true info about the blobs etc
    python3 GetTrueInfo.py ${JOBNAME}_25bar_Efilt 1 0nubb
