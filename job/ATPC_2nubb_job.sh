...
if [ "$MODE" == "1bar" ]; then
    ...
    sed -i "s#.*output_file.*#/nexus/persistency/output_file ATPC_2nubb_1bar#" ${CONFIG}
    ...
    sed -i "s#.*output_file.*#/nexus/persistency/output_file ATPC_2nubb_5bar#" ${CONFIG}
    ...
    sed -i "s#.*output_file.*#/nexus/persistency/output_file ATPC_2nubb_10bar#" ${CONFIG}
    ...
    sed -i "s#.*output_file.*#/nexus/persistency/output_file ATPC_2nubb_15bar#" ${CONFIG}
    ...
    sed -i "s#.*output_file.*#/nexus/persistency/output_file ATPC_2nubb_25bar#" ${CONFIG}
