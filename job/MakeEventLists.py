...
modes = ["ATPC_0nubb", "ATPC_Bi", "ATPC_Tl", "ATPC_single"]
pressures = ["1bar", "5bar", "10bar", "15bar", "25bar"]
diffs = ["0.1percent", "0.25percent", "0.0percent", "5percent", "nodiff"]
...
for m in modes:
    for p in pressures:
        ...
        if (p != "1bar"):
            ...
            diffs = ["0.1percent", "0.25percent", "5percent", "nodiff", "0.0percent"]
